...
export const timelineEvents: EventItem[] = [
  {
    ...
    notes: 'Join us for a relaxed afternoon lunch in the Tuscan countryside. A chance to catch up before the big day.',
  },
  {
    id: '2',
...
export const attireSections: AttireSection[] = [
  {
    id: '1',
    title: 'Formal Attire',
    description: 'The ceremony and reception call for formal attire. Think elegant, refined, and celebration-ready. The venue is outdoors with indoor options, so plan for warm Tuscan summer evenings.',
    images: [
  ...
  },
  {
    ...
    description: 'For the welcome lunch and farewell brunch, think polished but relaxed. Tuscan countryside vibes.',
    images: [
...
export const travelInfo: TravelSection = {
  airports: [
    { name: 'Florence Airport (Peretola)', code: 'FLR', driveTime: '1 hour 15 min', recommended: true },
    { name: 'Pisa International Airport', code: 'PSA', driveTime: '1 hour 45 min', recommended: true },
    { name: 'Rome Fiumicino Airport', code: 'FCO', driveTime: '2 hours 30 min', recommended: false },
    { name: 'Bologna Airport', code: 'BLQ', driveTime: '2 hours', recommended: false },
  ],
  arrivalWindow: {
  ...
  lodgingAreas: [
    { name: 'Siena Centro', description: 'Historic city center, walking distance to restaurants and sights. 20 min to venue.', priceRange: '$$$' },
    { name: 'Chianti Region', description: 'Charming countryside agriturismos and villas. 15-30 min to venue.', priceRange: '$$-$$$$' },
    { name: 'Castelnuovo Berardenga', description: 'Closest to the venue, quiet Tuscan village.', priceRange: '$$' },
  ],
  hotelBlock: {
  ...
  transport: [
    { type: 'Shuttle', description: 'Complimentary shuttle between Grand Hotel Continental Siena and all wedding events.', recommended: true },
    { type: 'Rental Car', description: 'Great for exploring Tuscany before or after the wedding. Book early for June!', recommended: true },
    { type: 'Taxi/Transfer', description: 'Private transfers can be arranged from airports. We can provide recommendations.', recommended: false },
  ],
  tips: [
